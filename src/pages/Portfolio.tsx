            ...
            >
              ...
              <div className={styles.content}>
                ...
                <div className={styles.links}>
                  {project.github && (
                    <a href={project.github} target="_blank" rel="noreferrer" className={styles.iconLink} title="View Code" aria-label={`View ${project.title} GitHub repository`}>
                  ...
                  {project.link && (
                    <a href={project.link} target="_blank" rel="noreferrer" className={styles.iconLink} title="Live Demo" aria-label={`Visit ${project.title} live demo`}>
